...
#[async_trait]
impl ToolHandler for GetFunctionNameByIndexHandler {
...
pub async fn register(server: &mut McpServer, app_handle: AppHandle) -> McpResult<()> {
    ...
    server
        .add_tool(
            "get_function_name_by_index".to_string(),
            Some("Get function display name by vector index".to_string()),
            json!({
                "type": "object",
            ...
            GetFunctionNameByIndexHandler { app_handle: ah },
        )
        .await?;
    Ok(())
}